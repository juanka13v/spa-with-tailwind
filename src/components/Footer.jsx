    ...
    <div className="w-full mt-24 bg-slate-900 text-gray-300 py-4 px-2">
      <div className="max-w-[1240px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8">
        ...
        <div className="col-span-2 pt-8 md:pt-2">
          ...
          <p className="py-4">
            The lastest news, articles, and resources, sent your inbox weekly
          </p>
      ...
      <div className="flex flex-col max-w-[1240px] px-2 py-4 m-auto justify-between items-center sm:flex-row text-center text-gray-500">
